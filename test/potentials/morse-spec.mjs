...
test("`d0` parameter validation", t => {
    t.throws(() => new Morse({d0: ""}), TypeError);
    t.throws(() => new Morse({d0: -1}), RangeError);
...
test("`r0` parameter validation", t => {
    t.throws(() => new Morse({r0: ""}), TypeError);
    t.throws(() => new Morse({r0: -1}), RangeError);
...
test("`a` parameter validation", t => {
    t.throws(() => new Morse({a: ""}), TypeError);
    t.throws(() => new Morse({a: -1}), RangeError);
