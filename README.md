...
![V(r)=4*epsilon((sigma/r)^12-(sigma/r)^6)](https://latex.codecogs.com/svg.latex?\large&space;{\color{Golden}V&#40;r&#41;=4\varepsilon\left[\left&#40;\frac{\sigma}{r}\right&#41;^{12}-\left&#40;\frac{\sigma}{r}\right&#41;^{6}\right]})
...
![V(r)=d0/(1-6/a)*(6/a*exp(a(1-r/r0))-(r0/r)^6)](https://latex.codecogs.com/svg.latex?\large&space;{\color{Golden}V&#40;r&#41;=\frac{D_0}{1-6/a}\left&#40;\frac{6}{a}\exp\left[a\left&#40;1-\frac{r}{r_0}\right&#41;\right]-\left&#40;\frac{r_0}{r}\right&#41;^{6}\right&#41;})
...
![V(r)=-d0+d0(1-exp(-a*(r-r0)))^2](https://latex.codecogs.com/svg.latex?\large&space;{\color{Golden}V&#40;r&#41;=-D_{0}&plus;D_{0}\left[1-\exp\left&#40;-a\left&#40;r-r_{0}\right&#41;\right&#41;\right]^{2}})
...
![V(r)=-d0(1+b(r-r0)/r0)*exp(-b(r-r0)/r0)](https://latex.codecogs.com/svg.latex?\large&space;{\color{Golden}V&#40;r&#41;=-D_{0}\left[1&plus;\frac{b}{r_{0}}\left&#40;r-r_{0}\right&#41;\right]\exp\left[-\frac{b}{r_{0}}\left&#40;r-r_{0}\right&#41;\right]})
...
![V(r)=-d0+d0(1-r0/r*exp(-b(r^2-r0^2)))^2](https://latex.codecogs.com/svg.latex?\large&space;{\color{Golden}V&#40;r&#41;=-D_0&plus;D_0\left[1-\frac{r_0}{r}\exp\left&#40;-b\left&#40;r^2-r_0^2\right&#41;\right&#41;\right]^2})
